	...
	<body>
		...
		<div class="container-fluid">
			...
			<div id="wrapper">
				<div id="sub-wrapper" >
					<div id="titre">
						<h1 class="titre text-center">Billet simple pour l'Alaska</h1>
					</div>
				</div>
				...
				<div id="sub-wrapper" >
					...
					<aside id="sidebar" class="col-xs-12 col-md-3 pull-right">
						<table>
							<tr>
								<th>Derniers chapitres publiés</th>
							</tr>
							<?php foreach ($lastposts as $lastpost): ?>
							<tr>
									<td><?= $lastpost['title'] ?> le <?= $lastpost['date_creation'] ?></td>
							</tr>
							<?php endforeach; ?>
						</table>
					</aside>

					<div id="main" class="col-xs-12 col-md-offset-1 col-md-7">
						<?= $contenu ?>
					</div>
